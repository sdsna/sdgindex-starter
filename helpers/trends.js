...
const TRENDS = [
  {
    ...
    color: "green",
    icon: ArrowUpThick,
    label: "On track or maintaining SDG achievement",
    shortLabel: "On track or maintaining SDG achievement",
  },
  {
    arrow: "➚",
    color: "yellow",
    icon: ArrowTopRightThick,
    label: "Score moderately improving, insufficient to attain goal",
    shortLabel: "Moderately improving",
  },
  {
    arrow: "→",
    color: "orange",
    icon: ArrowRightThick,
    label: "Score stagnating or increasing at less than 50% of required rate",
    shortLabel: "Stagnating",
  },
  {
    arrow: "↓",
    color: "red",
    icon: ArrowDownThick,
    label: "Score decreasing",
    shortLabel: "Decreasing",
  },
  {
    arrow: NO_TREND,
    color: "gray",
    icon: TrendNotAvailableIcon,
    label: "Trend information unavailable",
    shortLabel: "Trend information unavailable",
  },
];
